...
app = {               # REQUIRED dict, must be named 'app'
    ...
    'macros' : [      # List of button macros...
        ...
        # 3rd row ----------
        (0x800000, '', []),
        (0x04541B, 'Mute', [[ConsumerControlCode.MUTE]]),
        (0x800000, '', []),
        # 4th row ----------
        (0x660556, '<<', [[ConsumerControlCode.SCAN_PREVIOUS_TRACK]]),
        (0x660556, 'Play/Pause', [[ConsumerControlCode.PLAY_PAUSE]]),
        (0x660556, '>>', [[ConsumerControlCode.SCAN_NEXT_TRACK]]),
        # Encoder button ---
        (0x000000, '', [])
    ]
}
